...
final class BOL_UserService {
    ...
    public function countUsersByQuestionValuesCustom($questionValues, $isAdmin = false) {
        return $this->userDao->countUsersByQuestionValuesCustom($questionValues, $isAdmin);
    }
...
//        echo '</pre>';
        ...
        return $this->userDao->findUserIdListByQuestionValuesCustom($data['data'], $data['first'], $data['count'], $data['isAdmin'], $data['aditionalParams']);
    }
