...
class SKANDROID_ACTRL_Base extends OW_ApiActionController {
    ...
    public function checkApi() {
        $this->assign("data", array("androidApi" => true));
    }
    ...
    public function siteInfo(array $params = array()) {
        ...
        if (OW::getUser()->isAuthenticated()) {
            ...
            $this->assign("userInfo", array(
                ...
                "avatarUrl" => $avatarService->getAvatarUrl($userId, 1),
                "bigAvatarUrl" => $avatarService->getAvatarUrl($userId, 2),
                "origAvatarUrl" => $avatarService->getAvatarUrl($userId, 3),
                "isAvatarApproved" => !$avatarInfo ? true : (bool) $avatarInfo->getStatus() == BOL_ContentService::STATUS_ACTIVE,
