...
class SKANDROID_ACTRL_User extends OW_ApiActionController
{
    ...
    public function avatarChange()
    {
        ...
        BOL_AvatarService::getInstance()->setUserAvatar($userId, $file);
    ...
    private static function dataForUserAvatar( $userId )
    {
        ...
        $result["bigAvatarUrl"] = $bigAvatar ? SKADATE_BOL_Service::getInstance()->getAvatarUrl($userId, $bigAvatar->hash) : BOL_AvatarService::getInstance()->getAvatarUrl($userId, 2, null, true, false);
