...
//        $document->addStyleSheet(OW::getThemeManager()->getThemeService()->getStaticUrl(OW::getThemeManager()->getCurrentTheme()->getDto()->getName()) . "slider.css");
        //echo "scripti->" . OW::getPluginManager()->getPlugin('base')->getStaticJsUrl(OW::getThemeManager()->getCurrentTheme()->getDto()->getName() . '/js/') . 'jquery.jcarousellite.js';
//        $document->addScript(OW::getPluginManager()->getPlugin('base')->getStaticJsUrl(OW::getThemeManager()->getCurrentTheme()->getDto()->getName() . '/js/') . 'jquery.jcarousellite.js');
